...
export class ProfileService {
  constructor(@InjectRepository(CustomerProfileEntity) private profileRepo: Repository<CustomerProfileEntity>,@InjectRepository(CustomerEntity)private customerRepo: Repository<CustomerEntity>) {}
...
async deleteProfile(customerId: number): Promise<object> {
  ...
  // Remove only the profile entity, customer remains intact
